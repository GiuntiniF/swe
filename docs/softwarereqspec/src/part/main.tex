...
Le figure seguenti mostrano il diagramma delle classi di ciascun
package del Domain Model, secondo le dipendenze mostrate nel
package diagram.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{diagrams/class/ValueType.pdf}
