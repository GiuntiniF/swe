...
\begin{xltabular}{\textwidth}{|l|X|}
  ...
  \ucnote{
    ...
    scheda, e lo fa senza restrizioni legate alle assegnazioni attive:
    a differenza delle sessioni di allenamento, nome e descrizione non
    hanno effetto su ciò che gli atleti stanno seguendo. Le sessioni
    di allenamento restano modificabili solo con il caso d'uso PT-04,
    che invece richiede l'assenza di assegnazioni attive.
  } \\ \hline
\end{xltabular}
\end{document}
